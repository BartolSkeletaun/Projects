...
namespace MBProject
{
	[Activity(Label = "MyBuild", MainLauncher = true, Theme = "@style/mytheme", Icon = "@drawable/Icon")]
...
//			return view;
...

		{
			...
			public class Fragment5 : Android.Support.V4.App.Fragment
			{
				...
				public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
				{
					var view = inflater.Inflate(Resource.Layout.Frag5Layout, container, false);

					mTextView = view.FindViewById<TextView>(Resource.Id.textView1);
					mTextView.Text = "Social";
					return view;
				}
