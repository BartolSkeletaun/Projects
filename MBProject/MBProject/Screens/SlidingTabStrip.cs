...
namespace MBProject
{
	public class SlidingTabStrip : LinearLayout
	{
		...
		private const byte DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = 0X00;
		private const int SELECTED_INDICATOR_THICKNESS_DIPS = 5;
		private int[] INDICATOR_COLORS = { 0x000000, 0xd3d3d3 };
		private int[] DIVIDER_COLORS = { 0x000000 };
		...
		public SlidingTabStrip (Context context, IAttributeSet attrs) : base(context, attrs)
		{
			...
			mBottomBorderPaint.Color = GetColorFromInteger(0x000000 ); //black
